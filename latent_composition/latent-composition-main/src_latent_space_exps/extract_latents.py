...
if __name__ == "__main__":   
  ...
  # src_image_folder = os.path.join(root_path, 'augmentations/filtered_att_style_dataset/hair_style')
  # src_image_folder = os.path.join(root_path, 'augmentations/filtered_att_dirs_dataset/age')

  src_image_folder = os.path.join(root_path, 'augmentations/filtered_att_dirs_dataset/beard')
